...
target_sbdb = SBDB.query(comet_MPC_codes)

mpc_codes = [comet_MPC_codes] 
import pprint
pprint.pprint(target_sbdb)
target_spkid = target_sbdb['object']['spkid']
target_name = target_sbdb['object']['fullname']
...
batch.filter(
    epoch_start=target_sbdb['orbit']['first_obs'],
    epoch_end=target_sbdb['orbit']['last_obs'],
)
